...
class ElasticSearch {
	...
	*/
	...
	async get(model, params = {}) {
		...
		params.limit = params.limit || this.config.limit;
		params.page = params.page || 1;
		params.filters = params.filters ? ElasticSearchFilters.getFilters(params.filters) : {};
		params.order = params.order ? this._parseSortingParams(params.order) : {};
		...
		try {
			const res = await this.client.search({
				...
				from: params.limit * (params.page - 1),
				size: params.limit
			});
